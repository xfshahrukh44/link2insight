...
export const getInfo = async (urls) => {
    ...
    const browser = await puppeteer.launch({ headless: "new", executablePath: '/home/servicedemoweb/.cache/puppeteer/chrome/linux-119.0.6045.105/chrome-linux64/chrome.exe' });
